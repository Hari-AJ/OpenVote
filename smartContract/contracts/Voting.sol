...
contract Voting {
    ...
    function addCandidate(string memory _partyName, string memory _candidateName, string memory _partyLogo, string memory _candidateLogo) public {
        ...
        candidates[candidatesCount] = Candidate(candidatesCount, _partyName, _candidateName,_partyLogo,_candidateLogo,0);
        candidatesCount++;
        ...
        returns (string memory, string memory, uint256, string memory, string memory)
    {
        ...
        return (
            ...
            candidates[_candidateId].candidateLogo
        );
